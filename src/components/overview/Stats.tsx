...
const Stats = ({
    ...
    return (
        <div className="flex flex-wrap gap-4 justify-evenly mt-[30px]">
            <div className="flex flex-col gap-1 glass p-4">
                <h2 className="text-lg font-medium text-muted-foreground">
                    Total EVs
                </h2>
                {loading ? (
                    <p className="text-lg sm:text-2xl font-bold">Calculating...</p>
                ) : (
                    <p className="text-xl sm:text-2xl font-bold">{stats?.totalVehicles}</p>
                )}
            </div>
            <div className="flex flex-col gap-1 glass p-2 sm:p-4">
                <h2 className="text-lg font-medium text-muted-foreground">
                    Average Range
                </h2>
                {loading ? (
